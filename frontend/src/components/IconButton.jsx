...
function IconButtonComponent(
  ...
  return (
    <button
      ...
      title={label}
      className={cn(
        "grid size-8 shrink-0 place-items-center rounded-full border border-transparent text-mg-secondary transition hover:border-mg-border hover:bg-mg-elevated hover:text-mg-primary disabled:opacity-40",
        focusRing,
        className,
      )}
      {...props}
