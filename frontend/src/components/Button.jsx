...
function ButtonComponent(
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex min-h-8 cursor-pointer items-center justify-center gap-1.5 rounded-mg px-3 text-xs font-semibold transition disabled:cursor-not-allowed disabled:opacity-40",
        focusRing,
        variants[variant],
        className,
      )}
