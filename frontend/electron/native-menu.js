...
function installNativeMenu(window, dispatch) {
  ...
  const template = [
    ...
    { label: "Help", submenu: [item("Documentation", "help:documentation", undefined, options), item("Node Authoring Guide", "help:nodes", undefined, options), item("Keyboard Shortcuts", "help:shortcuts", undefined, options), item("Diagnostics", "view:diagnostics", undefined, options), item("Report an Issue", "help:issues", undefined, options), item("Project Homepage", "help:homepage", undefined, options), { role: "about" }] },
  ];
