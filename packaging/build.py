...
REQUIRED=(ROOT/"lluna.py", ROOT/"frontend"/"forge.config.js", ROOT/"package-lock.json")
...
def main(argv=None):
    ...
    metadata=ROOT/"build"/"release-metadata"/"lluna_release.json";metadata.parent.mkdir(parents=True,exist_ok=True);metadata.write_text(json.dumps({"platform":platform_name,"architecture":args.architecture,"profile":args.profile},indent=2)+"\n",encoding="utf-8")
