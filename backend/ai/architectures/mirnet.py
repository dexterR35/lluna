...
# Antialiased Downsample is inlined via backend.ai.architectures.mirnet_antialias.
...
from backend.ai.architectures.mirnet_antialias import Downsample as downsamp
